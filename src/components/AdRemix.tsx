                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          <span className="ml-auto text-[10px] text-af-text-tertiary">#{i + 1}</span>
                        </div>

                        {/* Headline */}
                        <div>
                          <p className="text-[10px] font-semibold text-af-text-tertiary uppercase tracking-[0.06em] mb-1">Headline</p>
                          <p className="text-[12px] font-semibold text-af-text-primary leading-snug">{remix.headline}</p>
                        </div>

                        {/* Body */}
                        <div>
                          <p className="text-[10px] font-semibold text-af-text-tertiary uppercase tracking-[0.06em] mb-1">Body</p>
                          <p className="text-[11px] text-af-text-secondary leading-relaxed whitespace-pre-line line-clamp-6">
                            {remix.body}
                          </p>
                        </div>
                        ...
                        {/* CTA */}
                        <div>
                          <p className="text-[10px] font-semibold text-af-text-tertiary uppercase tracking-[0.06em] mb-1">CTA</p>
                          <p className="text-[11px] text-af-text-secondary">{remix.cta}</p>
                        </div>

                        {/* Actions */}
                        <div className="flex items-center gap-2 pt-1 border-t border-af-border-subtle">
                          <button
                            onClick={() => handleUseInEditor(remix)}
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded text-[11px] font-semibold bg-af-accent border border-af-accent text-white hover:bg-af-accent-hover transition-all"
                          >
                          ...
                          <CopyButton text={remix.body} label="Copy Body" />
                        </div>
                      </div>
                    );
                  })}
